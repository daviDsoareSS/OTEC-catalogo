<a href="" target="_blank" style="text-decoration: none;" class="btn-whatsapp">
    <section class="end-section">
        <div class="content">
            <div class="wrapper-end-section">
                <h3>
                Aqui, com a <strong></strong>, no <i>atacado </i>poderá comprar <strong>5 itens</strong>,
                por exemplo, ao invés de comprar uma caixa inteira
                </h3>
                <div class="button-fale">
                    <h4>Fale agora com nosso vendedor</h4>
                    <img class="clique" src="img/clique.webp" alt="Fale com nosso vendedor!" title="Fale com nosso vendedor!" width="40" height="42" loading="lazy">
                </div>
            </div>
        </div>
    </section>
...
<section class="lead">
    <div class="content">
        ...
        <form action="lead.php" class="form-lead" method="POST">
            ...
            <div class="terms">
                <input type="checkbox" name="checkbox" id="termos" required>
                <label for="termos">
                    Concordo com os <a href="termos.php">Termos de Uso</a> e <a href="termos.php">Privacidade</a> do 
                </label>
            </div>
