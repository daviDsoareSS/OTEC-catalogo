...
<body>
            ...
            <div class="modal-content">
                <form action="" id="popup-exit" method="post">
                    ...
                    <div class="terms">
                        ...
                        <label for="termosPopup">Concordo com os <a href="">termos de uso</a> e <a href="">privacidade</a> da <strong>{{ getItem('client') }}</strong>.</label>
                    </div>
    ...
    @include('includes.section-contato')
